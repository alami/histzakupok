...
/**
 * This is the model class for table "aggreement".
 *
 * @property int $id
 ...
 */
class Aggreement extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['bid_id', 'currency_id', 'finance_id', 'org_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['date'], 'safe'],
            [['cost'], 'number'],
